...
export default {
    name: "charhelp",
    description: "Request help for creating a character and joining an on-going campaign!",
    defaultPermission: true,
    async execute(int, logger) {
        let mem = int.member as GuildMember;
        int.reply({
            content: "I'll send the relevant information to your DMs!",
            ephemeral: true
        })
        let dmChannel = await mem.createDM();

        logger.update("Sending character help to user...")
        // Init Welcome
        ...
        logger.update("Sent initial welcome message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent campaign join message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent name/misc options message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent race message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent class message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent proficiences message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent spells message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent abilities message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent description message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent character details message")
        ...
        embed = new EmbedBuilder()
            ...
            .setImage("https://cdn.discordapp.com/attachments/1023429667367170108/1023437412115951636/unknown.png");
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent physical characteristics message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent starting equipment message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent add starting equipment message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent equipping message")
        ...
        logger.update("Sent portraits messages")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent sharing message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent copying the link message")
        ...
        await dmChannel.send({embeds: [embed]});
        logger.update("Sent showcase message")
        ...
        embed = new EmbedBuilder()
            ...
            .setDescription(
                ...
                PS: if you're reading this first, scroll up!`
            )
            .setColor([167,17,15]);
        await dmChannel.send({embeds: [embed]});
